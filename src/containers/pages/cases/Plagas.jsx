  ...
  return (
    <Layout>
      ...
      <div className="max-w-4xl mx-auto py-12 px-4 mt-20">
        <h1 className="text-3xl font-bold mb-6 text-blue-600 dark:text-blue-400">Detección de Plagas con Visión por Computadora</h1>
        <picture>
        ...
        <section className="mb-8">
          <h2 className="text-xl font-semibold mb-2 text-blue-600 dark:text-blue-400">Impacto y Resultados</h2>
          <div className="bg-green-50 dark:bg-green-900/30 rounded p-4">
            <b className="text-gray-900 dark:text-gray-100">Beneficios Comprobados</b>
